...
The comparison between the two data analysis from the boxplot c19 and c52 shows the exact median for both and shows additional data such as height from the boxplot which is being represented in Q3 and 
